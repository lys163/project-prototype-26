...
class OAuth2SuccessHandlerTest {
    ...
    private static final String ACCESS_VALUE_FIXTURE = "synthetic-access-value";
    ...
    @Test
    void loginSuccessDoesNotLogTokenValuesAndPreservesDeliveryContracts(CapturedOutput output) throws Exception {
        ...
        when(jwtProvider.createAccessToken(userId)).thenReturn(ACCESS_VALUE_FIXTURE);
        ...
        assertThat(output.getAll())
                ...
                .doesNotContain(ACCESS_VALUE_FIXTURE, REFRESH_VALUE_FIXTURE);
        ...
        assertThat(response.getRedirectedUrl())
                .isEqualTo(FRONTEND_URL
                        + "/oauth/callback?accessToken=" + ACCESS_VALUE_FIXTURE
                        + "&isNewUser=true");
    }
}

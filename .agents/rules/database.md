...
- repository에는 Flyway, Liquibase, versioned migration file이 없습니다.
...
5. migration tooling이 승인되면 승인된 schema 변경에는 versioned migration을 만들고 `docs/DATABASE.md`에 문서화합니다.
